// Deposit resolution + amount computation. This is the Deno mirror of
// client/src/lib/deposit.ts — the two MUST stay in sync (create-payment computes
// the charge server-side; the booking form previews the same number client-side,
// and the normalize_guest_appointment trigger mirrors the same rules in SQL).
